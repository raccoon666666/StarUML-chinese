...
ExtensionManagerViewModel.prototype._setInitialFilter = function () {
  ...
  this.filterSet = this.sortedFullSet.slice()
...
RegistryViewModel.prototype._initializeFromSource = function () {
  ...
  return ExtensionManager.downloadRegistry()
    .done(function () {
      ...
      self.sortedFullSet = RegistryUtils.sortRegistry(self.extensions, 'registryInfo')
...
InstalledViewModel.prototype._sortFullSet = function () {
  ...
  this.sortedFullSet = this.sortedFullSet.sort(function (key1, key2) {
    ...
    var metadata2 = self.extensions[key2].installInfo.metadata
    var id1 = (metadata1.title || metadata1.name).toLowerCase()
    var id2 = (metadata2.title || metadata2.name).toLowerCase()
    if (id1 < id2) {
      return -1
    } else if (id1 === id2) {
      return 0
