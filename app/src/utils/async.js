 ...
 * @return {$.Promise}
 */
function doInParallelAggregateErrors (items, beginProcessItem) {
  var errors = []
...
/** @private Value passed to fail() handlers that have been triggered due to withTimeout()'s timeout */
var ERROR_TIMEOUT = {}
...
exports.doInParallelAggregateErrors = doInParallelAggregateErrors
